game: main.c spacecraft.o enemies.o hitboxes.o utils_thread.o
...
hitboxes.o: hitboxes.c hitboxes.h spacecraft.o enemy.o utils_thread.o
	gcc -c -o hitboxes.o hitboxes.c

spacecraft.o: spacecraft.c spacecraft.h bullet.o utils_thread.o
...
bullet.o: bullet.c bullet.h utils_thread.o
